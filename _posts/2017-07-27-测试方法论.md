...
### 菱形测试模型
&emsp;&emsp;从网上能找到的观点认为是因为互联网发布快所以来不及做单元测试，以及微服务模式，所以互联网的测试重心是API测试。我没有互联网行业从业经验，单纯从网上的找到的信息和结论，我个人只认同一部分，即偏向业务层代码因为业务变化快速容易导致单元测试维护成本变大，因此可以弱化单元测试规模。但如果是针对平台框架代码，应该还是建议往金字塔模型演进。（个人理解，后续有收获到其他想法在补充修改）。
