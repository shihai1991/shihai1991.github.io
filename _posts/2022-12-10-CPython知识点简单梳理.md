...
实际在生成unicodeobject的最后阶段，有一段函数处理逻辑会把长度刷新为unicode的个数长度（如：这个示例字符串实际长度是6，会被刷新为2）[代码链接](https://github.com/python/cpython/blob/36a0b1d0dddbdf324d98071ea31e7e9151eea6d5/Objects/unicodeobject.c#L13115)。
