...
# gcc test_len.c -o test_len $(python3.11-config --cflags) -L/usr/local/lib/python3.11/config-3.11d-x86_64-linux-gnu -lpython3.11d -lpthread -ldl  -lutil -lm  -Xlinker -export-dynamic
