...
## 2.2 [ChatGLM](https://chatglm.cn/blog)
模型回答：由清华大学 KEG 实验室与智谱AI共同训练的大型语言模型，名为“ChatGLM”。ChatGLM 是由清华大学 KEG 实验室与智谱AI共同开发而成。  
有两个开源版本：ChatGLM-6B，ChatGLM-130B。

## 2.3 [nanoGPT](https://github.com/karpathy/nanoGPT)

## 2.4 [LLaMA](https://github.com/facebookresearch/llama)
meta开源的ChatGPT模型。

## 2.5 [langchain](https://langchain.readthedocs.io/en/latest/)

## 2.6 [chatterbot](https://chatterbot.readthedocs.io/)
