...
## 2.1 镜头(Lens)
是各领域专家在各自领域内对框架六大支柱的应用，通过定义`pillars`、`questions`、`choices`、`riskRules`来评估风险值，服务则根据评估值来制定改进计划。[一个自定义Len示例](https://github.com/aws-samples/custom-lens-wa-hub/blob/main/DynamoDB/custom-lensddb-v1.0.json)
