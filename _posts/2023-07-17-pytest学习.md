...
```
在执行测试中，测试函数通过执行`fixturedef = request._get_active_fixturedef(argname)`来反查参数对应的[fixutre](https://github.com/pytest-dev/pytest/blob/15fadd8c5cb6a4812c8b2a6ebcbb37c3d05eb7fe/src/_pytest/fixtures.py#L1068)，代码详情。
