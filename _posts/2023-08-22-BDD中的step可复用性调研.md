...
这个10年前的[discussion](https://groups.google.com/g/cukes/c/DzE_kGZx94I/m/5rf__N31qvAJ)中已经有些讨论了，结论是**`Gherkin`是一个合作工具而不是一门计算机语言**。因为这个议题是10年前的讨论过程，近10年的DSL及IDE发展是非常快的，10年后还是坚持10年前的讨论结论不一定合适。
