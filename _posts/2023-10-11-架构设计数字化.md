...
# 软件架构设计
## 历史背景
`软件架构`这个词在1969年第一次被提出，但在20世纪90年代才得到快速发展。
...
# 视图类别
## [4+1架构设计视图](https://www.cs.ubc.ca/~gregor/teaching/papers/4+1view-architecture.pdf)
...
- [什么是敏捷迭代](https://learn.microsoft.com/zh-cn/devops/plan/what-is-agile-development)
